...
import RocketLaunchingDetails from './components/RocketLaunchingDetails';
import querystring from 'querystring';
import './App.css';

const API_BASE_URL = "https://api.spacexdata.com/v3/launches?limit=100";
const DEVELOPED_BY="{Neha Sharma}"
        ...
        <div className="App">
          ...
          <Container fluid>
            <Row>
              ...
              <Col id="device"xs={12} sm={12} md={6} lg={10}  >
                <Row >
                  {data.map((details) => {
                    return (
                      <Col md={12} lg={3}>
                        <RocketLaunchingDetails details={details} />
                      </Col>
                    );
                  })}
                </Row>
